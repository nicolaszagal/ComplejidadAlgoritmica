...
import { Vuelo, Nodo, Grafo } from '../../Models/grafo.model';
...
export class VuelosService {
    ...
    private construirGrafo(vuelosData: Vuelo[]): void {
        vuelosData.forEach((vuelo) => {
            ...
            this.grafo[vuelo.origen].push(vuelo);
        });
    }
    ...
    calcularRuta(origen: string | null, destino: string | null): Vuelo[] | null {
        ...
        const nodosAbiertos: Nodo[] = [{ ciudad: origen, costoTotal: 0 }];
